        ...
        <div className="container mx-auto px-4">
          <VideoComparisonCarousel
            items={[
              ...
              {
                beforeVideo: "/videos/surface1.mp4",
                afterVideo: "/videos/surface0.mp4",
                title: "Surface Augmentation",
                className: "mb-8",
                extraImage: "/images/surface.png",
              },
              {
                beforeVideo: "/videos/spatial1.mp4",
                afterVideo: "/videos/spatial0.mp4",
                title: "Spatial Overlay",
                className: "mb-8",
                extraImage: "/images/spatial.png",
              },
              {
                beforeVideo: "/videos/transitional1.mp4",
                afterVideo: "/videos/transitional0.mp4",
                title: "Transitional Boundary",
                className: "mb-8",
                extraImage: "/images/transitional.png",
              },
              {
                beforeVideo: "/videos/dynamic1.mp4",
                afterVideo: "/videos/dynamic0.mp4",
                title: "Dynamic State",
                className: "mb-8",
                extraImage: "/images/dynamic.png",
              },
              {
                beforeVideo: "/videos/fire1.mp4",
                afterVideo: "/videos/fire0.mp4",
                title: "Dynamic State",
                className: "mb-8",
